...
```{python}
models = ["../Generators/paper2/location2/wind/withcape/","../Generators/paper2/location2/temp/","../Generators/paper2/location2/humid_topolu/", "../Generators/paper2/location2/precip/"]
modNm = ["Wind","Temperature","Humidity","Precip"]

data_folder = "../Data/loc2_all/"

dat = [load_data("../Data/wind_loc2/withcape/","coarse_test.nc","fine_test.nc"),load_data("../Data/loc2_all/","coarse_test.nc","fine_test_tq.nc",pred_num = 0),load_data("../Data/loc2_all/","coarse_test.nc","fine_test_tq.nc",inv_nm = "hr_topo_lu.pt", pred_num = 1), load_data("../Data/loc2_all/","coarse_test.nc", "fine_test_p.nc",inv_nm = "hr_topo_loc2.pt", precip = True)]
# cond_fields = xr.open_dataset(data_folder + "coarse_test.nc", engine="netcdf4")
# fine_fields = xr.open_dataset(data_folder + "fine_test_tq.nc", engine="netcdf4")
# coarse = torch.from_numpy(cond_fields.to_array().to_numpy()).transpose(0, 1)
# fine = torch.from_numpy(fine_fields.to_array().to_numpy()).transpose(0, 1)
...
ds1 = NetCDFSR(coarse, fine, inv_2x, device=device)
ds2 = NetCDFSR(coarse, fine, inv_2f, device=device)


res_all = make_rapsd(models, modNm, ds_ls, [0,0,0,0], "RASP")
