# -*- coding: utf-8 -*-
"""
Created on Sat Dec  3 12:55:07 2022
...
class Generator(nn.Module):
    ...
    def __init__(self, filters, fine_dims, channels_coarse, channels_invariant, n_predictands=2, num_res_blocks=16, num_upsample=3):
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.Conv2d(fine_dims + filters, fine_dims + filters, kernel_size=3, stride=1, padding=1),
            nn.LeakyReLU(),
            nn.Conv2d(fine_dims + filters, n_predictands, kernel_size=3, stride=1, padding=1),
        )
