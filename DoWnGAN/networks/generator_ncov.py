...
class Generator(nn.Module):
    ...
    def __init__(self, filters, fine_dims, channels_coarse, n_predictands=1, num_res_blocks_noise=2, num_res_blocks = 14, num_upsample=3):
        ...
        self.LR_pre = nn.Sequential(self.conv1, self.res_blocks_reg, self.conv2)
